...
class MarketplaceController extends GetxController {
  ...
  Future<void> toggleFavourite(String campaignId) async {
    final currentlyFavourite = _isFavourite(campaignId);
    final result = await _toggleFavourite(
  ...
  bool _isFavourite(String campaignId) {
    final inFeatured = featuredCampaigns.where((c) => c.id == campaignId);
    if (inFeatured.isNotEmpty) return inFeatured.first.isFavourite;
    final inNew = newCampaigns.where((c) => c.id == campaignId);
    if (inNew.isNotEmpty) return inNew.first.isFavourite;
    return false;
  }
